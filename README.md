...
The genome length is assessed by comparing the expected *S. pneumoniae* genome length to the observed genome length and calculating a Z score. By default, samples >2.58 standard deviations from the expected genome length fail QC. This corresponds to a minimum of 1251533 bp and a maximum of 2979640 bp. These values were determined assuming an expected *S. pneumoniae* genome length of 2115586.96 bp and a standard deviation of 334904.34 bp. These numbers were calculated from a data set of *S. pneumoniae* genomes found [here](/assets/databases/NCBI_Assembly_stats_20240124.txt). This database is original from the CDC pipeline [PHoeNIx](https://github.com/CDCgov/phoenix).
