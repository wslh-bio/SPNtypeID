...
def boundary(average, df, sample, number, column_name, validation):
...
if "Ratio of Actual:Expected Genome length" in validation.columns:
    for sample in validation["Ratio of Actual:Expected Genome length"].index.get_level_values('Sample').unique():
        ...
        if sample == "SPN_Sample_01":
            validation = boundary(args.sample_1_ratio_avg, test_data, sample, "0.0025", "Ratio of Actual:Expected Genome length", validation)
        elif sample == "SPN_Sample_02":
            validation = boundary(args.sample_2_ratio_avg, test_data, sample, "0.0025", "Ratio of Actual:Expected Genome length", validation)
        elif sample == "SPN_Sample_03":
            validation = boundary(args.sample_3_ratio_avg, test_data, sample, "0.0025", "Ratio of Actual:Expected Genome length", validation)
...
if "Z score" in validation.columns:
    for sample in validation["Z score"].index.get_level_values('Sample').unique():
        ...
        diff = abs(valid_data-test_data)
        if sample == "SPN_Sample_01":
            validation = boundary(args.sample_1_z_avg, test_data, sample, "0.025", "Z score", validation)
        elif sample == "SPN_Sample_02":
            validation = boundary(args.sample_2_z_avg, test_data, sample, "0.025", "Z score", validation)
        elif sample == "SPN_Sample_03":
            validation = boundary(args.sample_3_z_avg, test_data, sample, "0.025", "Z score", validation)
