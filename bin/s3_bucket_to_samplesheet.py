...
def parse_args(args=None):
    Description = (
        "Generate nf-core/viralrecon samplesheet from a S3 bucket of FastQ files."
    )
    Epilog = "Example usage: python s3_bucket_to_samplesheet.py <FASTQ_S3> <SAMPLESHEET_FILE>"

    parser = argparse.ArgumentParser(description=Description, epilog=Epilog)
    parser.add_argument("FASTQ_S3", help="S3 location (S3://bucket-name/key-name) containing raw FastQ files.")
